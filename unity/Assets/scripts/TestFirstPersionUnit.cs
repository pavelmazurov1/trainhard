...
public class TestFirstPersionUnit : MonoBehaviour
{
    ...
    {
        //
        transform.Rotate( 0, Input.GetAxis("Mouse X") * Time.deltaTime * GameData.LookSensivity, 0);
        characterCamera.transform.Rotate(-Input.GetAxis("Mouse Y") * Time.deltaTime * GameData.LookSensivity, 0, 0);
